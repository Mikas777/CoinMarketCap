...
public partial class Cryptocurrency(CryptocurrencyDTO cryptocurrencyDTO) : PageViewModelBase
{
    [ObservableProperty]
    private int _rank  = cryptocurrencyDTO.Rank;
    [ObservableProperty]
    ...
    partial void OnPriceUsdChanged(decimal? value)
    {
        ...
        _previousPriceUsd = (decimal)value!;
